    ...
    render() {
        return (
            <div className="nguyenly">
                ...
                <img src={require("../../assets/images/bocong.png")} alt="#"/> <br />
                <img src={require("../../assets/images/bocong0.png")} alt="#"/>
                <p>-Bộ cộng n bit</p>
                <p>+Bộ cộng 4 bit</p>
                <img src={require("../../assets/images/bocong1.png")} alt="#"/> <br />
                <img src={require("../../assets/images/bocongnbit.png")} alt="#"/>
                ...
                <img src={require("../../assets/images/Cout.png")} alt="#"/>
                ...
                <img src={require("../../assets/images/congtrucodau.png")} alt="#"/> <br />
                <img src={require("../../assets/images/over.png")} alt="#"/>
                ...
                <img src={require("../../assets/images/nhansonguyen.png")} alt="#"/>
                ...
                <img src={require("../../assets/images/Booth.png")} alt="#"/>
                <h3 id="chiasonguyen">5. Chia số nguyên</h3>
                <h4>a. Chia số nguyên không dấu</h4>
                <img src={require("../../assets/images/chia.png")} alt="#"/>
                ...
                <img src={require("../../assets/images/chiacodau.png")} alt="#"/>
                <p>
